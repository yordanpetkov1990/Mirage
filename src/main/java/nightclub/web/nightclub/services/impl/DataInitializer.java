...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if(jobService.isEmpty()){
            jobService.addJob(new Job("Bartender",
            ...
            jobService.addJob(new Job("Security Guard",
            ...
            jobService.addJob(new Job("Waitstaff",
            ...
            jobService.addJob(new Job("Event Coordinator",
            ...
            jobService.addJob(new Job("Host/Hostess",
